...
function showTranslationCard(text: string, sourceLang: string, targetLang: string) {
  ...
  // Add event listeners
  const audioButton = card.querySelector('.peak-translation-card-audio-button') as HTMLButtonElement;
  const saveButton = card.querySelector('.peak-translation-card-save-button') as HTMLButtonElement;
